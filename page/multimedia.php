...
$result = mysqli_query($koneksi, "SELECT * FROM user_profiles WHERE kelas_ukm = 'Multimedia' ");
...
<h3 class="border-bottom border-secondary">
    <div class="pb-3 px-4">
        <i class="bi bi-pen-fill me-3"></i>MULTIMEDIA
    </div>
</h3>
...
<div class="px-5 mt-4">
    <div class="card">
      ...
      <div class="card-body">
        <div><span class="display-4 fw-bold me-2"><?php echo $multiMediaTotal ?? 0 ?></span><span class="display-6">member</span></div>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="" class="btn btn-primary">edit</a> || <a href="dashboardAdmin.php?page=delete&next=multimedia&id=<?php echo $web_advanced["id"]; ?>" class="btn btn-danger">delete</a></td>
            </tr>
            <?php $number++ ?>
            <?php endwhile; ?>
        </tbody>
